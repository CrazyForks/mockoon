...
Since Firebase Functions uses GCP Functions underhood, a slightly different approach can be used with the [functions-framework-nodejs](https://github.com/GoogleCloudPlatform/functions-framework-nodejs):
